...
function RecyclingCategories({ categories }) {
  ...
  //         <p>Category: </p>
  //         <p>Description:</p>
  //         <p>Here's how to upcycle</p>
  //         <iframe
  //           width="560"
  //           height="315"
  //           src="https://www.youtube.com/embed/Rlvd-dIAHCE"
  //           frameborder="0"
  //           allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  //           allowfullscreen
  //         ></iframe>
  ...
  //       <div className="col-lg-6">
  //         <img
  //           src="https://upload.wikimedia.org/wikipedia/commons/9/9d/Cardboard_Boxes_and_their_History.jpg"
  //           className="img-fluid"
  //         />
  //       </div>
  //     </div>
