...
function ElectronicCard({ electronic }) {
  //   console.log("finale", electronicSites);

  // const allDaelectronicSites = electronicSites.map((electronic) => electronic.ig);
      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          <p className="card-text">
            {electronic.address}, {electronic.borough}
          </p>
